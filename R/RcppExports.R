...
getDiscreteStates <- function(stateSelection, stateDuration, patientIDs, patientData, statePriorityVector, allowedStatesList) {
    .Call(`_Cohort2Trajectory_getDiscreteStates`, stateSelection, stateDuration, patientIDs, patientData, statePriorityVector, allowedStatesList)
}
