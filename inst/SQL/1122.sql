...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1305058,21601423,21603929)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1305058,21601423,21603929)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (140168,4307925,81931,140168,4307925,81931)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (140168,4307925)
  and c.invalid_reason is null
...
JOIN #Codesets cns on (de.drug_source_concept_id = cns.concept_id and cns.codeset_id = 0)
) C
