...
The standard approach involves using the default configuration, data import, and preprocessing steps, as described in [getting started](a00_introduction.html#study-configuration).
